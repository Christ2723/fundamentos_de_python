...
while not re.search(regrex_numbers, limite):
    limite = input("Digite la cantidad de pokemones a mostrar: ")
...
while id_digitado < primero or id_digitado > ultimo:
  ...
  ￼
    ...
    print(f"Ocurrio un error ({respuesta.status_code}) al obtener los datos") one
    ultimo = None
